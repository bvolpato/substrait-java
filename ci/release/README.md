...
- Github Artifacts:
  - https://github.com/substrait/substrait-java/releases
...
```shell
[10:30:55 PM] [semantic-release] [@semantic-release/github] › ℹ  Created issue #3: https://github.com/substrait/substrait-java/issues/3.
```
